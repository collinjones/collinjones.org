...
<html>
	...
	<body>
		...
		<div class="content-wrapper">
			<h2> About Me </h2>
			<p style="height: 10%; padding-left: 0;"> My name is Collin Jones. I'm studying to get my Bachelor's in Computer Science at the University of Colorado, Boulder.
		 	...
		 	<div class='row'>
		    	...
		    	<div class='column'>
					...
					<iframe style="margin-left: 0; margin-right: auto; min-width: 50%; max-width: 100%;" width="560" height="315" src="https://www.youtube.com/embed/a5d9QV4ngeU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		      	</div>
		    </div>
		    <div class="row">
		    	<div class="column">
		    		...
		    		<iframe style="box-shadow: 1px 1px 10px black; align-self: center; margin: auto; margin-top: auto; border: 0; width: 300px; height: 400px;"src="https://open.spotify.com/embed/track/29MKK9Ud7aqCJ54obver5W" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
		    	</div>
		    </div>
		</div>
